...
#	click on 'Format Cells', and then "Custom". In the "Type" or "Formatting" box, change
...
#	folders for each of the individual sims- Sim1_1, Sim1_2, ... Sim20_5. Open up the folders to check that
#	each of these subfolders has an output.nc file, which means that the simulation ran.
#       you will also find a CSV file sim_summary.csv which summarizes what AirTemp offset is associated with each sim folder
#
