...
# Question numbers referenced in parentheses correspond to questions in the
# associated student hand-out.
...
#   computers, you may not get a message. As long as you don't get an error,
#   you should be ok!
...
#  NOTE: You may need to copy and paste the folder name of the lake you are modeling
#  into the quotation marks above, but remember to change the direction of the slashes!

# This line of code sets your sim_folder as the working directory 
setwd(sim_folder) 
# The point of this step is to make sure that any new files you create (e.g., 
# figures or output) end up together in this folder.
...
#  atmospheric warming impact on a 20-year time horizon as CO2. 
