...
# This module was initially developed by Farrell, K.J. and C.C. Carey. DD Mon. 2018.
 # Macrosystems EDDIE: Teleconnections. 
 # Macrosystems EDDIE Module 3, Version 1. 
 # https://serc.carleton.edu/enviro_data/macrosystems/module3.html
...
# This script was modified last by KJF on 5 Mar. 2018.
...
sim_folder <- './Teleconnections/Mendota'
