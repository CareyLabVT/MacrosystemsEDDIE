...
mypath <- paste0(getwd(), '/EDI_Publishing/Macrosystems_EDDIE_Module_6_ForecastUncertainty')
...
make_eml(path = mypath,
         ...
         user.id = "melofton",
         user.domain = 'EDI',
         package.id = "edi.1100.7") # Put your package.id here, followed by .1 (for 1st version)
