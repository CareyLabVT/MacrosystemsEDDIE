...
make_eml(path = mypath,
         ...
         user.id = "melofton",
         user.domain = 'EDI',
         package.id = "edi.1802.3") # Put your package.id here, followed by .1 (for 1st version)
...
make_eml(path = mypath,
         ...
         user.id = "ccarey",
         user.domain = 'EDI',
         package.id = "edi.2289.2") # Put your package.id here, followed by .1 (for 1st version)
