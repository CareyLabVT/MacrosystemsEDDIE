...
sim_folder <- paste0(getwd(), '/EDI_Publishing/Macrosystems_EDDIE_Module_8_DecisionSupport')

make_eml(path = sim_folder,
         dataset.title = "Macrosystems EDDIE Module 8: Using Ecological Forecasts to Guide Decision-Making (Instructor Materials)",
         ...
         user.id = "ccarey",
         user.domain = 'EDI',
         package.id = "edi.808.2") # Put your package.id here, followed by .1 (for 1st version)
