...
make_eml(path = "./EDI_Publishing/Macrosystems_EDDIE_Module_1_Climate_Change_Effects_on_Lake_Temperatures",
         ...
         temporal.coverage = c("2017-06-30", "2026-03-09"),
         ...
         user.id = "melofton",
         user.domain = 'EDI',
         package.id = "edi.1805.3") # Put your package.id here, followed by .1 (for 1st version)
...
make_eml(path = "./EDI_Publishing/Macrosystems_EDDIE_Module_1_Climate_Change_Effects_on_Lake_Temperatures",
         ...
         user.id = "ccarey",
         user.domain = 'EDI',
         package.id = "edi.270.3") # Put your package.id here, followed by .1 (for 1st version)
