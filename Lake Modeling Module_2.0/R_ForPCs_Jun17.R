...
#  To complete this activity, you will need to modify the input meteorological data and then run the
...
get_nml_value(nml, 'meteo_fl') # If you have done this correctly, you should get an output that lists
    # the name of your new meteorological file altered for your weather/climate scenario. Plot your weather file, using
    # the commands you already learned above.
...
library(GRAPLEr) # If this loads successfully, you should get a return statement that says something like, "GRAPLEr
