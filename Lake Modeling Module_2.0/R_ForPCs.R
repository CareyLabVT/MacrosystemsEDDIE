...
# This script was last modified by KJF on 19 October 2017.
...
#  a line of code, I marked that particular line with ##!! symbols at the beginning 
#  of that line's annotation.  If you do not see those symbols, then you do not 
#  need to edit that line of code (you can merely run it as normal).
...
sim_folder <- 'C:/Users/farrellk/Desktop/lake_climate_change' ##!! Edit this line 
#  of code to redefine your sim_folder path. This should be replaced with the path 
#  to the Desktop folder where you extracted your zipped files. Most likely, you 
#  will need to change the part after Users/ to give the name of your computer 
#  (e.g., my computer name is farrellk, but yours will be different!). Look in 
#  the Files tab on RStudio to see your file path. 
...
#  first asking what the lake name is in the nml file. Then try using this 
#  command learn the 'lake_depth', 'num_inflows', 'latitude', 'longitude', etc. 
...
#  observed and modeled data for comparison. Try changing this command to compare 
...
#  To complete this activity, you will need to modify the input meteorological 
...
#  the components of the#  proposed scenario. For example, which of the 
#  meteorological variables (air temperature, precipitation, wind, etc.) will be 
#  modified and how? Will they be short-term or long-term modifications? After 
#  you develop your scenario, work with a partner to hypothesize how these changes 
#  will affect Awesome Lake's thermal structure.

# 3) Test your hypotheses! Run the GLM using your new met file and examine how it 
#  alters the physical structure of the lake. How does your climate scenario change 
#  the thermal structure of the lake? What does the temperature profile look like?  
#  How does the depth of the thermocline change? How does the timing of 
#  stratification and magnitude of evaporation change?

# 4) Compare the modeled output to the observed. What are the implications of your 
#  climate scenario for future water quality and quantity?

# 5) Create and save a few figures to highlight the results of your climate scenario 
#  and present them to the rest of the class. It would be helpful to present both 
#  the meteorological input file as well as the lake thermal plots so that we can 
#  see how the lake responded to your climate forcing.
...
# 2- SOMETHING THAT IS REALLY REALLY IMPORTANT! 
  ...
  # an error something like this: "Day 2451545 (2000-01-01) not found". To get 
  # around this error, you need to follow the FIVE steps listed below.

	# FIRST, copy and paste an extra version of the met_hourly.csv file in your sim 
    # folder so that you have a backup in case of any mistakes. Rename this file 
    # something like "met_hourly_UNALTERED.csv" and be sure *not* to open it.
    ...
    # intuitive-- open up the Variable_Name_Metadata.csv file from the module zipped 
...
get_nml_value(nml, 'meteo_fl') # If you have done this correctly, you should get 
    ...
    # your weather/climate scenario. Plot your weather file, using the commands 
    # you already learned above.

	# FIFTH, you can now run the model with the new edited nml file, following the 
    # instructions as described above for Objective 3.  Exciting!
...
# Prepare figures to share with your classmates that demonstrate the effects of 
#  your many GRAPLEr-enabled climate change scenarios on the thermal structure of 
#  your model lake. 
